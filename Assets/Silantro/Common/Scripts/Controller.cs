...
namespace Oyedoyin.Common
{
    ...
    public class Controller : MonoBehaviour
    {
        ...
        public float crashImpactForce = 5000f; 
        ...
        //public float groundCheckRadius = 0.1f;  // Radius of the sphere cast

        //public bool isOnGround
        //{
        //    get
        //    {
        //        // Perform a sphere cast to check if we are grounded
        //        return Physics.CheckSphere(transform.position - Vector3.up * (0.5f), groundCheckRadius, groundLayer);
        //    }
        //}
